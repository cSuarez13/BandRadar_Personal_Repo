...
export default function Index() {
    ...
    const [[, favoriteIds], setFavoriteIds] = useStorageState<string[]>('favoriteConcerts');
    ...
    return (
        <View style={{flex: 1, backgroundColor: '#121212'}}>
            <View style={{
                ...
                >
                    <Text style={{ color: 'yellow', fontSize: 24, marginRight: 8 }}>★</Text>
                    <Text style={{ color: 'white', fontSize: 16 }}>Favorites</Text>
                </TouchableOpacity>
            </View>
                    ...
                    renderItem={({item}) => (
                        <TouchableOpacity
                            ...
                            >
                                <Text
                                    style={{
                                        color: favoriteIds && favoriteIds.includes(item.id) ? 'yellow' : 'white',
                                        fontSize: 24, // Increase this value for a bigger star
                                        fontWeight: 'bold',
                                        textShadowColor: '#000',
